...
const Sidebar = ({ active, setActive }) => {
  ...
  return (
    <div className="dashboard-sidebar11 w-full overflow-hidden rounded-lg border-[1px] bg-[#fff9f9] border-[#30404D]">
      <h2 className="bg-[#FCC79F] text-[white] font-bold text-[22px] space-x-1 w-full py-[10px] px-[15px]">
        My Profile
      </h2>
      {/* <p
        onClick={() => setActive(1)}
